...
const translations = {
  en: {
    ...
    companyValues: {
      ...
      valuesSubtitle: "Rooted in tradition, growing towards a sustainable future",
      valuesDescription: "We believe in the resilient wisdom of our ancestors—a philosophy where nature is both healer and provider. Our commitment to transparency means offering you pure, organic nourishment without processing or additives. Every seed carries the vital energy of the Amazon, connecting you to a natural way of living that honors the earth and its ancient rhythms. This is food as medicine, respecting the sacred balance between humanity and nature.",
      value1Title: "Sustainability",
      value1Desc: "Protecting the Amazon for future generations",
      value1TitleMobile: "Sustainability",
      value2Title: "Quality",
      value2Desc: "Premium organic products, naturally sourced",
      value2TitleMobile: "Quality",
      value3Title: "Community",
      value3Desc: "Supporting local farmers and their families",
      value3TitleMobile: "Community",
      value4Title: "Authenticity",
      value4Desc: "True to our roots, honest in our practices",
      value4TitleMobile: "Authenticity",
      value5Title: "Wellness",
      value5Desc: "Nourishing body and soul naturally",
      value5TitleMobile: "Wellness",
      value6Title: "Nature",
      value6Desc: "Working in harmony with the environment",
  ...
  es: {
    ...
    companyValues: {
      ...
      valuesDescription: "Creemos en la sabiduría resiliente de nuestros ancestros—una filosofía donde la naturaleza es sanadora y proveedora. Nuestro compromiso con la transparencia significa ofrecerte nutrición pura y orgánica, sin procesamiento ni aditivos. Cada semilla lleva la energía vital de la Amazonía, conectándote con un estilo de vida natural que honra la tierra y sus ritmos ancestrales. Esto es alimento como medicina, respetando el equilibrio sagrado entre la humanidad y la naturaleza.",
      value1Title: "Sostenibilidad",
      value1Desc: "Protegiendo la Amazonía para las futuras generaciones",
      value1TitleMobile: "Sostenibilidad",
      value2Title: "Calidad",
      value2Desc: "Productos orgánicos premium, de origen natural",
      value2TitleMobile: "Calidad",
      value3Title: "Comunidad",
      value3Desc: "Apoyando a los agricultores locales y sus familias",
      value3TitleMobile: "Comunidad",
      value4Title: "Autenticidad",
      value4Desc: "Fieles a nuestras raíces, honestos en nuestras prácticas",
      value4TitleMobile: "Autenticidad",
      value5Title: "Bienestar",
      value5Desc: "Nutriendo cuerpo y alma de forma natural",
      value5TitleMobile: "Bienestar",
